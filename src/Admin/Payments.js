...
const Payments = () => {
  ...
  // Generate an array of dynamic dates based on the first dataset's graphData length
  ...
  useEffect(() => {
    ...
    .then(response => {
      // Expecting the API to return an object with a "notifications" array.
  ...
  const handleMarkAllAsRead = async () => {
    ...
    try {
      ...
      // Update notifications in state to have status "read"
  ...
  // Calculate unread notifications count (only count notifications that are not marked as read)
