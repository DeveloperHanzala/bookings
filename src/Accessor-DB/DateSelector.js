...
const DateSelector = () => {
  const { jobid } = useParams(); // Get job ID directly from URL parameters
  ...
  return (
    <>
      ...
      <div className="container pt-5 pb-5 text-center">
        ...
        <div className="mt-4">
          <Link 
            to={`/accessor/quote/${jobid}`} // Pass jobid in URL
            state={{ jobData: jobData, selectedDate:selectedDate }} // Pass date via state
          >
            <button
