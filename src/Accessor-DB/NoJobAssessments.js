...
import HouseTypes from "./NoJobAssessments/HouseTypes";
import Age from "./NoJobAssessments/Age";
import Age1 from "./NoJobAssessments/Age1";
import TypeofRating from "./NoJobAssessments/TypeofRating";
import WallConstruction from "./NoJobAssessments/WallConstruction";
import Roof from "./NoJobAssessments/Roof";
import Ground from "./NoJobAssessments/Ground";
import FloorArea from "./NoJobAssessments/FloorArea";
import Opening from "./NoJobAssessments/Step2/Opening";
import Roomdata from "./NoJobAssessments/Step2/Roomdata";
import Ventilation from "./NoJobAssessments/Step2/Ventilation";
import LightingSummary from "./NoJobAssessments/Step2/LightingSummary";
import PrimaryS from "./NoJobAssessments/Step3/PrimaryS";
import SecondaryS from "./NoJobAssessments/Step3/SecondaryS";
import PrimaryF from "./NoJobAssessments/Step3/PrimaryF";
import SecondaryF from "./NoJobAssessments/Step3/SecondaryF";
import GOLBoiler from "./NoJobAssessments/Step3/GOLBoiler";
import SFboiler from "./NoJobAssessments/Step3/SFboiler";
import Comments from "./NoJobAssessments/Step3/Comments";
import HeatPumps from "./NoJobAssessments/Step3/HeatPumps";
import ElectricRoom from "./NoJobAssessments/Step3/ElectricRoom";
import CHP from "./NoJobAssessments/Step3/CHP";
import PrimaryHWS from "./NoJobAssessments/Step 4/PrimaryHWS";
import SolarHWS from "./NoJobAssessments/Step 4/SolarHWS";
import ShowersBath from "./NoJobAssessments/Step 4/ShowersBath";
import Commentsstep4 from "./NoJobAssessments/Step 4/Commentsstep4";
import Heatingcontrols from "./NoJobAssessments/Step 5/Heatingcontrols";
import UFH from "./NoJobAssessments/Step 5/UFH";
import DLS from "./NoJobAssessments/Step 6/DLS";
import HeatingS1 from "./NoJobAssessments/Step 6/HeatingS1";
import CommentsStep5 from "./NoJobAssessments/Step 6/CommentsStep5";
...
import Age2 from "./NoJobAssessments/Age2";
import WallConstruction1 from "./NoJobAssessments/WallConstruction1";
import Roof1 from "./NoJobAssessments/Roof1";
import Ground1 from "./NoJobAssessments/Ground1";
import WallConstruction3 from "./NoJobAssessments/WallConstruction3";
import Roof3 from "./NoJobAssessments/Roof3";
import Ground3 from "./NoJobAssessments/Ground3";
import WallConstruction4 from "./NoJobAssessments/WallConstruction4";
import Roof4 from "./NoJobAssessments/Roof4";
import Ground4 from "./NoJobAssessments/Ground4";
import Step7_form from "./NoJobAssessments/Step7/Step7_form";
const NoJobAssessments = () => {
    const { jobId } = useParams();
    console.log("id ye pari h" + jobId)
...
individual_chp: false,
 ...
 solar_water_haeting : "",
  ...
  const apiUrl = `https://backend.homecert.ie/api/private_assessment/${jobId}/`;
  ...
  const handleChange = async (e) => {
    ...
    try {
      await axios.put(apiUrl, { jobId, ...updatedFormData } , {
        headers: {
    ...
    <React.Fragment key={step}>
      ...
      {step < 7 && (
        ...
        <div className="form-content">
          {currentStep === 1 && <Step1  formData={formData} id={jobId}  handleChange={handleChange} />}
          {currentStep === 2 && <Step2  formData={formData} handleChange={handleChange} />}
          {currentStep === 3 && <Step3  formData={formData} id={jobId}  handleChange={handleChange} />}
          {currentStep === 4 && <Step4  formData={formData} id={jobId}  handleChange={handleChange} />}
          {currentStep === 5 && <Step5  formData={formData} id={jobId}  handleChange={handleChange} />}
          {currentStep === 6 && <Step6  formData={formData} id={jobId}  handleChange={handleChange} />}
          {currentStep === 7 && <Step7  formData={formData} id={jobId}  handleChange={handleChange} />}
          {currentStep === 8 && <Step8  formData={formData} id={jobId}  handleChange={handleChange} />}
        </div>
...
export default NoJobAssessments;
