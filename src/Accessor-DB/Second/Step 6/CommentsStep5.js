...
const CommentsStep5 = () => {
  return (
    <>
 <h6 className="fw-bold">Any other comments or details on assessment including items observed which affect the rating but not shown elsewhere on survey form/sketches. *</h6>
