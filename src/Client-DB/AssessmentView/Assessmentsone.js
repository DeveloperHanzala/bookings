...
import '../../Accessor-DB/Assessments.css'
...
individual_chp: false,
 ...
 solar_water_haeting : "",
  ...
  const apiUrl = `https://backend.homecert.ie/api/assessments/${assessmentId}/`;

  // Fetch data when user lands on the page
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const message = error.response?.data?.detail || "Failed to fetch data";
    ...
    <React.Fragment key={step}>
      ...
      {step < 7 && (
        ...
        <div className="form-content">
          {currentStep === 1 && <Step1  formData={formData} id={assessmentId}  handleChange={handleChange} />}
          {currentStep === 2 && <Step2  formData={formData} handleChange={handleChange} />}
          {currentStep === 3 && <Step3  formData={formData} id={assessmentId}  handleChange={handleChange} />}
          {currentStep === 4 && <Step4  formData={formData} id={assessmentId}  handleChange={handleChange} />}
          {currentStep === 5 && <Step5  formData={formData} id={assessmentId}  handleChange={handleChange} />}
          {currentStep === 6 && <Step6  formData={formData} id={assessmentId}  handleChange={handleChange} />}
          {currentStep === 7 && <Step7  formData={formData} id={assessmentId}  handleChange={handleChange} />}
          {currentStep === 8 && <Step8  formData={formData} id={assessmentId}  handleChange={handleChange} />}
        </div>
...
>
  {currentStep === 8 ? "Back to Dashboard" : "Next"}
</button>
